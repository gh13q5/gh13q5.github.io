---
title: "[네트워크 관리사 2급 실기] 라우터(Router) 문제"
author: gh13
date: 2022-04-02 15:15:00 +0800
categories: [IT Memo]
tags: [CS (Computer Science), 네트워크]
...
라우터 문제는 주로 cmd 명령어나 리눅스와 비슷한 문제라 주요 명령어들만 외워두면 편하다. 특히 모든 문제에 공통으로 들어가는 명령어를 잘 설명해주기 때문에 영상을 한 번 보고 다른 문제들을 찾아보며 공부하는 걸 추천!
...
> `ip add`는 ip를 할당, `ip route는 라우팅(정적라우팅)
{: .prompt-tip }
...
> `ip default-network IP주소`도 출제한 적 있으니 주의!
{: .prompt-tip }
